...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_betterstack"></a> [betterstack](#module\_betterstack) | aws-ia/eks-blueprints-addon/aws | 1.1.1 |
...
| <a name="module_harbor"></a> [harbor](#module\_harbor) | aws-ia/eks-blueprints-addon/aws | 1.1.1 |
...
| Name | Type |
|------|------|
| [aws_acm_certificate.harbor](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/acm_certificate) | resource |
| [aws_acm_certificate_validation.harbor](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/acm_certificate_validation) | resource |
...
| [aws_route53_record.harbor_validation](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/route53_record) | resource |
...
| [kubectl_manifest.gp3_storage_class](https://registry.terraform.io/providers/gavinbunney/kubectl/1.19.0/docs/resources/manifest) | resource |
...
| [aws_route53_zone.intermediate_domain](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/data-sources/route53_zone) | data source |
| [aws_secretsmanager_secret.letsencrypt](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/data-sources/secretsmanager_secret) | data source |
| [aws_secretsmanager_secret_version.letsencrypt](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/data-sources/secretsmanager_secret_version) | data source |
...
|------|-------------|------|---------|:--------:|
| <a name="input_aws_region"></a> [aws\_region](#input\_aws\_region) | The region where the infrastructure should be deployed to | `string` | `"us-west-1"` | no |
| <a name="input_betterstack_ingestion_host"></a> [betterstack\_ingestion\_host](#input\_betterstack\_ingestion\_host) | Betterstack host to capture kubernetes logs [Source - shared-services-dev-eks] | `string` | n/a | yes |
| <a name="input_betterstack_logs_source_token"></a> [betterstack\_logs\_source\_token](#input\_betterstack\_logs\_source\_token) | Token to Capture logs on BetterStack [Source - shared-services-dev-eks] | `string` | n/a | yes |
...
| <a name="input_deploy_stage"></a> [deploy\_stage](#input\_deploy\_stage) | The environment short name to use for the deployed resources (for tagging purposes)<br/><br/>  Options:<br/>  - dev<br/>  - chimera<br/>  - prod<br/><br/>  Default: dev | `string` | `"dev"` | no |
| <a name="input_domain_type"></a> [domain\_type](#input\_domain\_type) | Intermediate domain type | `string` | `"c"` | no |
...
| <a name="input_letsencrypt_secret"></a> [letsencrypt\_secret](#input\_letsencrypt\_secret) | The Name of AWS SecretsManager secret for LetsEncrypt Configuration | `string` | n/a | yes |
...
| <a name="input_root_domain"></a> [root\_domain](#input\_root\_domain) | The TLD of the DNS to use for this deployment | `string` | n/a | yes |
| <a name="input_team"></a> [team](#input\_team) | Team that owns the application (for tagging purposes) | `string` | `"ionet-k8s"` | no |
| <a name="input_terraform_gitpath"></a> [terraform\_gitpath](#input\_terraform\_gitpath) | The location in source control where terraform code exists (for tagging purposes) | `string` | `"ionet-k8s/terraform-shared-services"` | no |
...
| <a name="output_harbor_iam_user_login_password"></a> [harbor\_iam\_user\_login\_password](#output\_harbor\_iam\_user\_login\_password) | Harbor IAM User password for AWS console access (Set new password on first login) |
| <a name="output_harbor_iam_user_secretmanager_secret"></a> [harbor\_iam\_user\_secretmanager\_secret](#output\_harbor\_iam\_user\_secretmanager\_secret) | Name of the SecretManager Secret containing Harbor IAM User credentials |
| <a name="output_harbor_rds_pg_master_connection_secretmanager_secret"></a> [harbor\_rds\_pg\_master\_connection\_secretmanager\_secret](#output\_harbor\_rds\_pg\_master\_connection\_secretmanager\_secret) | Name of the SecretManager Secret containing Harbor RDS DB Instance credentials |
| <a name="output_harbor_s3_bucket"></a> [harbor\_s3\_bucket](#output\_harbor\_s3\_bucket) | Harbor S3 Bucket for storing HelmChart & Image Artifacts |
| <a name="output_harbor_ui_admin_password"></a> [harbor\_ui\_admin\_password](#output\_harbor\_ui\_admin\_password) | Harbor UI Admin Password |
